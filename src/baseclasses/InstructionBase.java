...
public class InstructionBase {
	...
	public EnumComparison getComparison() {
		return comparison;
	}
	...
	public LabelTarget getLabelTarget() {
		return label_target;
	}
	...
	public InstructionBase duplicate() {
		...
		ins.label_target = this.getLabelTarget();
		ins.preceding_label = this.preceding_label;
